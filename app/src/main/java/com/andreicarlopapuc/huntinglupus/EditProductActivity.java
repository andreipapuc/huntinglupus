...
public class EditProductActivity extends Activity {
  ...
  //  EditText txtCreatedAt;
    ...
    // single product url
    //10.10.9.216
    private static final String url_product_detials = "http://10.10.10.149/hl_androidcon/get_product_details.php";

    // url to update product
    private static final String url_update_product = "http://10.10.10.149/hl_androidcon/update_product.php";

    // url to delete product
    private static final String url_delete_product = "http://10.10.10.149/hl_androidcon/delete_product.php";
