...
public class AdminAllProductsActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                String idnum = ((TextView) view.findViewById(R.id.idnum)).getText()
                        .toString();

                // Starting new intent
                Intent in = new Intent(getApplicationContext(),
                        EditProductActivity.class);
                // sending idnum to next activity
                in.putExtra(TAG_IDNUM, idnum);
    ...
    class LoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(AdminAllProductsActivity.this);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            AdminAllProductsActivity.this, productsList,
                            R.layout.list_item, new String[] { TAG_IDNUM,
                            TAG_NAME},
                            new int[] { R.id.idnum, R.id.name });
                    // updating listview
